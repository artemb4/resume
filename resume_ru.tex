...
Веду проекты со смежными сервисами, слежу за стабильностью сервисов.
...
% Yandex
    \resumeExpSubheading
      {\href{https://yandex.ru/maps}{Яндекс Лавка\ExternalLink}}{Санкт-Петербург, Россия}
...
\textbf{Frameworks:} & \quad Pytest, GTest, asyncio, FastAPI, Numpy \\
